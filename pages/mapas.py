...
def layout():
    ...
    return html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(kpi_card(f"{cluster_counts.get('C1', 0)} / {cluster_counts.get('C3', 0)} / {cluster_counts.get('Atípico', 0)}",
                             "Departamentos en cluster C1 / C3 / Atípico (Bogotá)"), md=3, className="mb-3"),
        ...
        section_text(
            ...
            "C3 (mayor peso del gasto en Salud, menor margen "
        ...
        figure_block(
            ...
            caption=html.Span([
                ...
                "Distribución territorial de los clusters C1 y C3 de "
